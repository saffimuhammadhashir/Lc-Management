export function SimpleBeneficiaryFuction8(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber8 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber8");
            if (SimpleBENEFICIARYCertificateLCNumber8.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant8");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal8 = document.getElementById("SimpleBENEFICIARYCertificateGlobal8");
            if (SimpleBENEFICIARYCertificateGlobal8.checked) {
            ...
            let text5 = document.getElementById('Bene8ModelShippmentDate').value ? document.getElementById('Bene8ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle8").value;
            ...
            let LongText2 = document.getElementById('Bene8ModelFreeText').value;
