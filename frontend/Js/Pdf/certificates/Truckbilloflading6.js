export function TruckBillofladingFunction6(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
...
// Dynamic Text Data
let text1 = document.getElementById('TruckBillOfLadingCertificateother6ModalTitle').value ? document.getElementById('TruckBillOfLadingCertificateother6ModalTitle').value : "TRUCK BILL OF LADING";              
...
// Long Text 
let LongText1 = document.getElementById('TruckBillOfLading6_FreeText1').value ? document.getElementById('TruckBillOfLading6_FreeText1').value : document.getElementById("lcInformationPageAWDorBLMerchadiseDescription").value ;
