export function SimpleBeneficiaryFuction5(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber5 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber5");
            if (SimpleBENEFICIARYCertificateLCNumber5.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant5");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal5 = document.getElementById("SimpleBENEFICIARYCertificateGlobal5");
            if (SimpleBENEFICIARYCertificateGlobal5.checked) {
            ...
            let text5 = document.getElementById('Bene5ModelShippmentDate').value ? document.getElementById('Bene5ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle5").value;
            ...
            let LongText2 = document.getElementById('Bene5ModelFreeText').value;
