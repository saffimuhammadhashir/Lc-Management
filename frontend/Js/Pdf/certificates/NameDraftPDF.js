export function nameDraftFunction(
    pdf,
    printText,
    OriginalOrCopy,
    createCell,
    ...
    DraftNumber
      ...
      if(document.querySelector('input[name="draftForCollectionorPayment"]:checked').value === "draftForCollection") {
      ...
      // checkbox
      checkbox(pdf, 0.7, 7.1, 0.2, 0.2, !document.getElementById("draftOnApproval").checked);
      checkbox(pdf, 0.7, 7.5, 0.2, 0.2, !document.getElementById("draftAuthorityToPay").checked);
      ...
      let text3 = "";
      if(document.getElementById('DraftOriginalNumber').value == 2){
        if(DraftNumber == 0){
      ...
      if(document.getElementById('DraftOriginalNumber').value == 1){
      ...
      // const words = convertCurrencyToWords(Homepage_LcAmount, currency.currency_name_singular, currency.currency_name_plural, currency.currency_fraction_name_singular, currency.currency_fraction_name_plural);
      // console.log(`${Homepage_LcAmount} in words: ${words}`);
      ...
      const text12 = document.getElementById("simpleDraftModelAdvisingBankRef").value;
      ...
      if(document.getElementById('simpleDraftModelNegoBank').value){
        let temp  =  document.getElementById('simpleDraftModelNegoBank').value
    ...
    let text48 = document.getElementById('storecustomer_CUSTOMER_ABA').value;
     ...
     freeTextForDraft = document.getElementById("DraftFreeText").value
     ...
     longText(pdf, freeTextForDraft.toUpperCase(), 3.6, 9.13, 3.40, 8, true, true);
      ...
      printText(pdf, 5.2, 2.90, text13.toUpperCase(), true, 6);
