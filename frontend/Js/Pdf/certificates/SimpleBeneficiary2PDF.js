export function SimpleBeneficiaryFuction2(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber2 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber2");
            if (SimpleBENEFICIARYCertificateLCNumber2.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant2");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal2 = document.getElementById("SimpleBENEFICIARYCertificateGlobal2");
            if (SimpleBENEFICIARYCertificateGlobal2.checked) {
            ...
            let text5 = document.getElementById('Bene2ModelShippmentDate').value ? document.getElementById('Bene2ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle2").value;
            ...
            let LongText2 = document.getElementById('Bene2ModelFreeText').value;
