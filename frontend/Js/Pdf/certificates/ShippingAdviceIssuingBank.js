export function shippingAdviceIssuingBankFunction(
    pdf,
    printText,
    OriginalOrCopy,
    createCell,
    ...
    // 3. Global Check
    let LongText3 = "";
    var ShippingAdviceIssuingBank_GlobalCheck = document.getElementById("ShippingAdviceIssuingBank_GlobalCheck");
    if (ShippingAdviceIssuingBank_GlobalCheck.checked) {
    ...
    let text7 = document.getElementById('ShippingAdviceIssuingBank_Name').value ? document.getElementById('ShippingAdviceIssuingBank_Name').value : selectedValue;              
    ...
    let text6 = document.getElementById("ShippingAdviceIssuingBank_HomeTitle").value;
    printText(pdf, 2.9, 2.68, text6, true, 16);
  
  
  
  
    let text8 = document.getElementById("lcInformationPageIssuingBankName").value;
    printText(pdf, 3.7, 3.1, text8, true, 8);
  
    mylongText(pdf, document.getElementById('lcInformationPageIssuingBankAddress').value, 3.7, 3.2, 4.0, 8, true, false);
  
  
    printText(pdf, 0.57, 3.90, "FAX NUMBER: " + document.getElementById('ShippingAdviceIssuingBankModalFaxNumber').value, true, 8);
  
    let FreeText1 = document.getElementById('ShippingAdviceIssuingBankModel_FreeText1').value ? document.getElementById('ShippingAdviceIssuingBankModel_FreeText1').value : "";              
    let FreeText2 = document.getElementById('ShippingAdviceIssuingBankModel_FreeText2').value ? document.getElementById('ShippingAdviceIssuingBankModel_FreeText2').value : "";              
    
    mylongText(pdf, FreeText1, 0.57, 4.10, 7.0, 8, true, false);
    mylongText(pdf, FreeText2, 0.57, 4.40, 7.0, 8, true, false);
  
  
   let text5 = document.getElementById("ShippingAdviceIssuingBankModalShippmentDate").value ? document.getElementById("ShippingAdviceIssuingBankModalShippmentDate").value: document.getElementById("Homepage_ShipDate").value;
    ...
    if (airRadio.checked) {
      console.log("air");
      text15 = document.getElementById("ShippingAdviceIssuingBankModel_CarrierName").value;
      text16 = document.getElementById("ShippingAdviceIssuingBankModel_AWBNumber").value;
      ...
      text19 = document.getElementById("ShippingAdviceIssuingBankModel_FlightNumber").value;
      text20 = document.getElementById("ShippingAdviceIssuingBankModel_AirFrom").value;
      text21 = document.getElementById("ShippingAdviceIssuingBankModel_AirTo").value;
      ...
      printText(pdf, 4.00, 6.0, text20, true, 7);
    ...
    let longTestDescription = document.getElementById('ShippingAdviceIssuingBankModel_MerchandiseDescription').value ? document.getElementById('ShippingAdviceIssuingBankModel_MerchandiseDescription').value : document.getElementById("lcInformationPageShippingAdviceMerchadiseDescription").value;              
    mylongText(pdf, longTestDescription.toUpperCase(), 4.00, 6.38, 4.0, 7.5, true, true, "courier");  
    pdf.setFont("helvetica", "bold");
  
  
    let text22 = document.getElementById("ShippingAdviceIssuingBankModel_InvoiceValue").value;
    let text23 = "";
    ...
    let text24 = document.getElementById("ShippingAdviceIssuingBankModel_NumberOfPackages").value;
    printText(pdf, 4.00, 7.60, text24, true, 8);
  
    
    printText(pdf, 2.41, 7.90, "GROSS WEIGHT: ", true, 8);
    let text25 = document.getElementById("ShippingAdviceIssuingBankModel_GrossWeight").value;
    printText(pdf, 4.00, 7.90, text25, true, 8);
  
    if (document.getElementById("TransportInformation_NetWeight").value) {
      let tempNetWeight = document.getElementById("ShippingAdviceIssuingBankModel_NetWeight").value;
    ...
    let text26 =  document.getElementById("ShippingAdviceIssuingBankModel_InvoiceNumber").value;
    ...
    let FreeText3 = document.getElementById('ShippingAdviceIssuingBankModel_FreeText3').value ? document.getElementById('ShippingAdviceIssuingBankModel_FreeText3').value : "";              
    ...
    let text29 = document.getElementById("LCInformation_BENEFICIARYName").value;
