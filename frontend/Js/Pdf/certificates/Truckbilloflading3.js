export function TruckBillofladingFunction3(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  // Dynamic Text Data
let text1 = document.getElementById('TruckBillOfLadingCertificateother3ModalTitle').value ? document.getElementById('TruckBillOfLadingCertificateother3ModalTitle').value : "TRUCK BILL OF LADING";              
...
// Long Text 
let LongText1 = document.getElementById('TruckBillOfLading3_FreeText1').value ? document.getElementById('TruckBillOfLading3_FreeText1').value : document.getElementById("lcInformationPageAWDorBLMerchadiseDescription").value ;
