export function SimpleBeneficiaryFuction3(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber3 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber3");
            if (SimpleBENEFICIARYCertificateLCNumber3.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant3");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal3 = document.getElementById("SimpleBENEFICIARYCertificateGlobal3");
            if (SimpleBENEFICIARYCertificateGlobal3.checked) {
            ...
            let text5 = document.getElementById('Bene3ModelShippmentDate').value ? document.getElementById('Bene3ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle3").value;
            ...
            let LongText2 = document.getElementById('Bene3ModelFreeText').value;
