export function EmailFormFunction7(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text2 = document.getElementById('EmailForm7_From').value ? document.getElementById('EmailForm7_From').value : "";              
  let text3 = document.getElementById('EmailForm7_Sent').value ? document.getElementById('EmailForm7_Sent').value : "";              
  let text4 = document.getElementById('EmailForm7_To').value ? document.getElementById('EmailForm7_To').value : "";              
  let text5 = document.getElementById('EmailForm7_Subject').value ? document.getElementById('EmailForm7_Subject').value : "";              
  let text6 = document.getElementById('EmailForm7_Attachment').value ? document.getElementById('EmailForm7_Attachment').value : "";              

  let text8 = formatDate(document.getElementById("Homepage_ShipDate").value);

  
 
  let longText1 = document.getElementById('EmailForm7_FreeText').value ? document.getElementById('EmailForm7_FreeText').value : "";              
  const longText2 = ``;
