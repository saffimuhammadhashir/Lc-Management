export function TruckBillofladingFunction4(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
...
// Dynamic Text Data
let text1 = document.getElementById('TruckBillOfLadingCertificateother4ModalTitle').value ? document.getElementById('TruckBillOfLadingCertificateother4ModalTitle').value : "TRUCK BILL OF LADING";              
...
// Long Text 
let LongText1 = document.getElementById('TruckBillOfLading4_FreeText1').value ? document.getElementById('TruckBillOfLading4_FreeText1').value : document.getElementById("lcInformationPageAWDorBLMerchadiseDescription").value ;
