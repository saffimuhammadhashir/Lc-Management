export function EmailFormFunction4(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text2 = document.getElementById('EmailForm4_From').value ? document.getElementById('EmailForm4_From').value : "";              
  let text3 = document.getElementById('EmailForm4_Sent').value ? document.getElementById('EmailForm4_Sent').value : "";              
  let text4 = document.getElementById('EmailForm4_To').value ? document.getElementById('EmailForm4_To').value : "";              
  let text5 = document.getElementById('EmailForm4_Subject').value ? document.getElementById('EmailForm4_Subject').value : "";              
  let text6 = document.getElementById('EmailForm4_Attachment').value ? document.getElementById('EmailForm4_Attachment').value : "";              

  let text8 = formatDate(document.getElementById("Homepage_ShipDate").value);

  
 
  let longText1 = document.getElementById('EmailForm4_FreeText').value ? document.getElementById('EmailForm4_FreeText').value : "";              
  const longText2 = ``;
