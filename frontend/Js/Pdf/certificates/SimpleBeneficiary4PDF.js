export function SimpleBeneficiaryFuction4(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber4 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber4");
            if (SimpleBENEFICIARYCertificateLCNumber4.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant4");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal4 = document.getElementById("SimpleBENEFICIARYCertificateGlobal4");
            if (SimpleBENEFICIARYCertificateGlobal4.checked) {
            ...
            let text5 = document.getElementById('Bene4ModelShippmentDate').value ? document.getElementById('Bene4ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle4").value;
            ...
            let LongText2 = document.getElementById('Bene4ModelFreeText').value;
