export function EmailFormFunction5(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text2 = document.getElementById('EmailForm5_From').value ? document.getElementById('EmailForm5_From').value : "";              
  let text3 = document.getElementById('EmailForm5_Sent').value ? document.getElementById('EmailForm5_Sent').value : "";              
  let text4 = document.getElementById('EmailForm5_To').value ? document.getElementById('EmailForm5_To').value : "";              
  let text5 = document.getElementById('EmailForm5_Subject').value ? document.getElementById('EmailForm5_Subject').value : "";              
  let text6 = document.getElementById('EmailForm5_Attachment').value ? document.getElementById('EmailForm5_Attachment').value : "";              

  let text8 = formatDate(document.getElementById("Homepage_ShipDate").value);

  
 
  let longText1 = document.getElementById('EmailForm5_FreeText').value ? document.getElementById('EmailForm5_FreeText').value : "";              
  const longText2 = ``;
