export function SteamshipFunction2(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  // Dynamic Text Data
  let text1 = document.getElementById('Steamship2_BeneName').value ? document.getElementById('Steamship2_BeneName').value : "STEAMSHIP CERTIFICATE";              
  let text2 = document.getElementById('Steamship2_ShipDate').value ? document.getElementById('Steamship2_ShipDate').value : document.getElementById('Homepage_ShipDate').value;              
  ...
  let LongText1 = document.getElementById('Steamship2_FreeText2').value ? document.getElementById('Steamship2_FreeText2').value : "";              
  let LongText2 = document.getElementById('Steamship2_SignatureLine').value ? document.getElementById('Steamship2_SignatureLine').value : "";
