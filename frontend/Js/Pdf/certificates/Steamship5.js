export function SteamshipFunction5(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  // Dynamic Text Data
  let text1 = document.getElementById('Steamship5_BeneName').value ? document.getElementById('Steamship5_BeneName').value : "STEAMSHIP CERTIFICATE";              
  let text2 = document.getElementById('Steamship5_ShipDate').value ? document.getElementById('Steamship5_ShipDate').value : document.getElementById('Homepage_ShipDate').value;              
  ...
  let LongText1 = document.getElementById('Steamship5_FreeText2').value ? document.getElementById('Steamship5_FreeText2').value : "";              
  let LongText2 = document.getElementById('Steamship5_SignatureLine').value ? document.getElementById('Steamship5_SignatureLine').value : "";
