export function DHLFormFunction5(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text12 = document.getElementById('DhlFormOther5_ChangeDate').value ? document.getElementById('DhlFormOther5_ChangeDate').value : document.getElementById("Homepage_ShipDate").value;           
  ...
  let LongText2 = document.getElementById('DhlFormOther5_FreeText').value ? document.getElementById('DhlFormOther5_FreeText').value : "";           
  let LongText3 = document.getElementById('DhlFormOther5_WayBill').value ? document.getElementById('DhlFormOther5_WayBill').value : "";           
