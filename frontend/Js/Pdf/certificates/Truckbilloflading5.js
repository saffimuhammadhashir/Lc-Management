export function TruckBillofladingFunction5(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
...
// Dynamic Text Data
let text1 = document.getElementById('TruckBillOfLadingCertificateother5ModalTitle').value ? document.getElementById('TruckBillOfLadingCertificateother5ModalTitle').value : "TRUCK BILL OF LADING";              
...
// Long Text 
let LongText1 = document.getElementById('TruckBillOfLading5_FreeText1').value ? document.getElementById('TruckBillOfLading5_FreeText1').value : document.getElementById("lcInformationPageAWDorBLMerchadiseDescription").value ;
