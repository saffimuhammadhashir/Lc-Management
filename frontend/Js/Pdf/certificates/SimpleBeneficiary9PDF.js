export function SimpleBeneficiaryFuction9(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber9 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber9");
            if (SimpleBENEFICIARYCertificateLCNumber9.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant9");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal9 = document.getElementById("SimpleBENEFICIARYCertificateGlobal9");
            if (SimpleBENEFICIARYCertificateGlobal9.checked) {
            ...
            let text5 = document.getElementById('Bene9ModelShippmentDate').value ? document.getElementById('Bene9ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle9").value;
            ...
            let LongText2 = document.getElementById('Bene9ModelFreeText').value;
