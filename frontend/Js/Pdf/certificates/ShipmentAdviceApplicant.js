export function shipmentAdviceApplicantFunction(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  // 1. LC Check
  let text4 = "";
  if (document.getElementById("ShippingAdviceApplicant_LCNumberCheck").checked) {
  ...
  let text7 = document.getElementById('ShippingAdviceApplicant_Name').value ? document.getElementById('ShippingAdviceApplicant_Name').value : selectedValue;              
  ...
  let text6 = document.getElementById("ShippingAdviceApplicant_HomeTitle").value;
  printText(pdf, 2.9, 2.68, text6, true, 16);




  let text8 = document.getElementById("lcInformationPageApplicantName").value;
  printText(pdf, 3.7, 3.1, text8, true, 8);

  mylongText(pdf, document.getElementById('lcInformationPageApplicantAddress').value, 3.7, 3.2, 4.0, 8, true, false);


  printText(pdf, 0.57, 3.90, "FAX NUMBER: " + document.getElementById('ShippingAdviceApplicantModelFaxNumber').value, true, 8);

  let FreeText1 = document.getElementById('ShippingAdviceApplicantModel_FreeText1').value ? document.getElementById('ShippingAdviceApplicantModel_FreeText1').value : "";              
  let FreeText2 = document.getElementById('ShippingAdviceApplicantModel_FreeText2').value ? document.getElementById('ShippingAdviceApplicantModel_FreeText2').value : "";              
  
  mylongText(pdf, FreeText1, 0.57, 4.10, 7.0, 8, true, false);
  mylongText(pdf, FreeText2, 0.57, 4.40, 7.0, 8, true, false);


 let text5 = document.getElementById("ShippingAdviceApplicantModelShippmentDate").value ? document.getElementById("ShippingAdviceApplicantModelShippmentDate").value: document.getElementById("Homepage_ShipDate").value;
  ...
  if (airRadio.checked) {
    console.log("air");
    text15 = document.getElementById("ShippingAdviceApplicantModel_CarrierName").value;
    text16 = document.getElementById("ShippingAdviceApplicantModel_AWBNumber").value;
    ...
    text19 = document.getElementById("ShippingAdviceApplicantModel_FlightNumber").value;
    text20 = document.getElementById("ShippingAdviceApplicantModel_AirFrom").value;
    text21 = document.getElementById("ShippingAdviceApplicantModel_AirTo").value;
  ...
  let longTestDescription = document.getElementById('ShippingAdviceApplicantModel_MerchandiseDescription').value ? document.getElementById('ShippingAdviceApplicantModel_MerchandiseDescription').value : document.getElementById("lcInformationPageShippingAdviceMerchadiseDescription").value;              
  mylongText(pdf, longTestDescription.toUpperCase(), 4.00, 6.38, 4.0, 7.5, true, true, "courier");  
  pdf.setFont("helvetica", "bold");


  let text22 = document.getElementById("ShippingAdviceApplicantModel_InvoiceValue").value;
  let text23 = "";
  ...
  let text24 = document.getElementById("ShippingAdviceApplicantModel_NumberOfPackages").value;
  printText(pdf, 4.00, 7.60, text24, true, 8);

  
  printText(pdf, 2.41, 7.90, "GROSS WEIGHT: ", true, 8);
  let text25 = document.getElementById("ShippingAdviceApplicantModel_GrossWeight").value;
  printText(pdf, 4.00, 7.90, text25, true, 8);

  if (document.getElementById("ShippingAdviceApplicantModel_NetWeight").value) {
    let tempNetWeight = document.getElementById("ShippingAdviceApplicantModel_NetWeight").value;
  ...
  let text26 =  document.getElementById("ShippingAdviceApplicantModel_InvoiceNumber").value;
  ...
  let FreeText3 = document.getElementById('ShippingAdviceApplicantModel_FreeText3').value ? document.getElementById('ShippingAdviceApplicantModel_FreeText3').value : "";              
