export function commercialPackingListFunction(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
   ...
   // ! There are 4 Checks DCS, LC Number, 2nd Applicant,
            ...
            let packingListLCNumberCheck = document.getElementById("packingListLCNumberCheck");
            ...
            // 2nd Applicant
            let packingListSecondApplicantCheck = document.getElementById("packingListSecondApplicantCheck");
            if (packingListSecondApplicantCheck.checked) {
                ...
                printText(pdf, 0.57, 1.50, "SOLD TO: ", true, 8);
            ...
            if (packingListGlobalCheck.checked) {
              ...
              // longText(pdf, LongText1.toUpperCase(), 0.57, 9.4, 7.0, 8, true, true);
  ...
  mylongText(pdf, document.getElementById('LCInformation_BENEFICIARYAddress').value, 0.57, 0.50, 4.0, 8, true, false);





  let text4 = document.getElementById("packingListHomeTitle").value;
  ...
  let text10 = document.getElementById('packingListModalInvoiceDate').value ? document.getElementById('packingListModalInvoiceDate').value : document.getElementById('TransportInformation_InvoiceDate').value;              
  ...
  let TransportInformation_NumberOfPiecesComponents = TransportInformation_NumberOfPieces.split(", ");
  let TransportInformation_NumberOfPiecesAll = TransportInformation_NumberOfPiecesComponents.join(",\n");
  const text13 = TransportInformation_NumberOfPiecesAll;
  const text15 = "COVERING:";

  // let longTestfree = document.getElementById("lcInformationPageShortMerchadiseDescriptionForBL").value
  let longTestfree = document.getElementById('packingListModalShortMerchadiseDescription').value ? document.getElementById('packingListModalShortMerchadiseDescription').value : document.getElementById('lcInformationPageShortMerchadiseDescriptionForBL').value;              
  ...
  if(document.getElementById("TransportInformation_GrossWeight").value){
    let text12 = document.getElementById("TransportInformation_GrossWeight").value + document.getElementById("TransportInformation_Measurements").value ;
  ...
  if(document.getElementById("TransportInformation_NetWeight").value){
    let tempNetWeight = document.getElementById("TransportInformation_NetWeight").value + document.getElementById("TransportInformation_Measurements").value ;
    printText(pdf, 4.25, 2.30, "NET WEIGHT: ", true, 8);
    printText(pdf, 5.50, 2.30, tempNetWeight.toUpperCase(), true, 8);
  }
  

  printText(pdf, 0.57, 2.75, "QUANTITY OR NO. OF PACKAGES/PIECES:", true, 8);
  printText(pdf, 3.10, 2.76, text13.toUpperCase(), true, 8);
  ...
  printText(pdf, 0.57, 4.60, text15.toUpperCase(), true, 8);
