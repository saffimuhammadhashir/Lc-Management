export function SimpleBeneficiaryFuction10(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber10 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber10");
            if (SimpleBENEFICIARYCertificateLCNumber10.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant10");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal10 = document.getElementById("SimpleBENEFICIARYCertificateGlobal10");
            if (SimpleBENEFICIARYCertificateGlobal10.checked) {
            ...
            let text5 = document.getElementById('Bene10ModelShippmentDate').value ? document.getElementById('Bene10ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle10").value;
            ...
            let LongText2 = document.getElementById('Bene10ModelFreeText').value;
