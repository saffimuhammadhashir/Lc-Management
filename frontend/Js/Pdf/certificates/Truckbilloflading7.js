export function TruckBillofladingFunction7(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
...
// Dynamic Text Data
let text1 = document.getElementById('TruckBillOfLadingCertificateother7ModalTitle').value ? document.getElementById('TruckBillOfLadingCertificateother7ModalTitle').value : "TRUCK BILL OF LADING";              
...
// Long Text 
let LongText1 = document.getElementById('TruckBillOfLading7_FreeText1').value ? document.getElementById('TruckBillOfLading7_FreeText1').value : document.getElementById("lcInformationPageAWDorBLMerchadiseDescription").value ;
