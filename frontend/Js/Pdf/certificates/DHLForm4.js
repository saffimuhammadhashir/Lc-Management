export function DHLFormFunction4(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text12 = document.getElementById('DhlFormOther4_ChangeDate').value ? document.getElementById('DhlFormOther4_ChangeDate').value : document.getElementById("Homepage_ShipDate").value;           
  ...
  let LongText2 = document.getElementById('DhlFormOther4_FreeText').value ? document.getElementById('DhlFormOther4_FreeText').value : "";           
  let LongText3 = document.getElementById('DhlFormOther4_WayBill').value ? document.getElementById('DhlFormOther4_WayBill').value : "";           
