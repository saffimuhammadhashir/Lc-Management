export function SimpleBeneficiaryFuction7(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber7 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber7");
            if (SimpleBENEFICIARYCertificateLCNumber7.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant7");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal7 = document.getElementById("SimpleBENEFICIARYCertificateGlobal7");
            if (SimpleBENEFICIARYCertificateGlobal7.checked) {
            ...
            let text5 = document.getElementById('Bene7ModelShippmentDate').value ? document.getElementById('Bene7ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle7").value;
            ...
            let LongText2 = document.getElementById('Bene7ModelFreeText').value;
