export function EmailFormFunction2(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text2 = document.getElementById('EmailForm2_From').value ? document.getElementById('EmailForm2_From').value : "";              
  let text3 = document.getElementById('EmailForm2_Sent').value ? document.getElementById('EmailForm2_Sent').value : "";              
  let text4 = document.getElementById('EmailForm2_To').value ? document.getElementById('EmailForm2_To').value : "";              
  let text5 = document.getElementById('EmailForm2_Subject').value ? document.getElementById('EmailForm2_Subject').value : "";              
  let text6 = document.getElementById('EmailForm2_Attachment').value ? document.getElementById('EmailForm2_Attachment').value : "";              

  let text8 = formatDate(document.getElementById("Homepage_ShipDate").value);

  
 
  let longText1 = document.getElementById('EmailForm2_FreeText').value ? document.getElementById('EmailForm2_FreeText').value : "";              
  const longText2 = ``;
