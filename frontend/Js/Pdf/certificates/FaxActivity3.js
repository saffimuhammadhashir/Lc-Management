export function FaxActivityFunction3(
    pdf,
    printText,
    OriginalOrCopy,
    createCell,
...
let text2 = "";
if(document.getElementById('FaxActivity3_FaxDate').value){
  text2 = document.getElementById('FaxActivity3_FaxDate').value ? document.getElementById('FaxActivity3_FaxDate').value : "";
} else {
  text2 = document.getElementById('FaxActivity3_PrintTime').value ? document.getElementById('FaxActivity3_PrintTime').value : "";
...
let text3 = document.getElementById('FaxActivity3_PrintTime2').value ? document.getElementById('FaxActivity3_PrintTime2').value : "";
let text4 = "ID";
let text5 = ""

if(document.getElementById('FaxActivity3_NoOfPages').value){
  text5 = document.getElementById('FaxActivity3_NoOfPages').value ? document.getElementById('FaxActivity3_NoOfPages').value : "";
} else {
  text5 = document.getElementById('FaxActivity3_TxTotalPages').value ? document.getElementById('FaxActivity3_TxTotalPages').value : "";

}


let text6 = document.getElementById('FaxActivity3_RXPage').value ? document.getElementById('FaxActivity3_RXPage').value : "";
let text7 = "00";
let text8 = document.getElementById('FaxActivity3_FileNo').value ? document.getElementById('FaxActivity3_FileNo').value : ""; 

let text9 = document.getElementById('FaxActivity3_StartTime').value ? document.getElementById('FaxActivity3_StartTime').value : ""; 
if(text9){
  text9 = formatDate(text9);

}
let text10 = document.getElementById('FaxActivity3_Mode').value ? document.getElementById('FaxActivity3_Mode').value : ""; 
let text11 = "RX";
let text12 = document.getElementById('FaxActivity3_Location').value ? document.getElementById('FaxActivity3_Location').value : ""; 
let text13 = document.getElementById('FaxActivity3_StorePage').value ? document.getElementById('FaxActivity3_StorePage').value : ""; 
let text14 = document.getElementById('FaxActivity3_TXPage').value ? document.getElementById('FaxActivity3_TXPage').value : ""; 
let text15 = document.getElementById('FaxActivity3_RXPage').value ? document.getElementById('FaxActivity3_RXPage').value : ""; 
let text16 = document.getElementById('FaxActivity3_TotalTime').value ? document.getElementById('FaxActivity3_TotalTime').value : "";              
let text17 = "Sec";
let text18 = document.getElementById('FaxActivity3_Code').value ? document.getElementById('FaxActivity3_Code').value : "";              
let text19 = document.getElementById("lcInformationPageLcNumber").value;

let Other3_SecondApplicantCheck = document.getElementById("Other3_SecondApplicantCheck");
