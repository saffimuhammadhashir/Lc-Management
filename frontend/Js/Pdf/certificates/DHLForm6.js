export function DHLFormFunction6(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text12 = document.getElementById('DhlFormOther6_ChangeDate').value ? document.getElementById('DhlFormOther6_ChangeDate').value : document.getElementById("Homepage_ShipDate").value;           
  ...
  let LongText2 = document.getElementById('DhlFormOther6_FreeText').value ? document.getElementById('DhlFormOther6_FreeText').value : "";           
  let LongText3 = document.getElementById('DhlFormOther6_WayBill').value ? document.getElementById('DhlFormOther6_WayBill').value : "";           
