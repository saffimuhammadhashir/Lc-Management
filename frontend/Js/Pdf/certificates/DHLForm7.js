export function DHLFormFunction7(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text12 = document.getElementById('DhlFormOther7_ChangeDate').value ? document.getElementById('DhlFormOther7_ChangeDate').value : document.getElementById("Homepage_ShipDate").value;           
  ...
  let LongText2 = document.getElementById('DhlFormOther7_FreeText').value ? document.getElementById('DhlFormOther7_FreeText').value : "";           
  let LongText3 = document.getElementById('DhlFormOther7_WayBill').value ? document.getElementById('DhlFormOther7_WayBill').value : "";           
