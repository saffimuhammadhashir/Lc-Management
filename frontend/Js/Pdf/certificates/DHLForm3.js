export function DHLFormFunction3(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  let text12 = document.getElementById('DhlFormOther3_ChangeDate').value ? document.getElementById('DhlFormOther3_ChangeDate').value : document.getElementById("Homepage_ShipDate").value;           
  ...
  let LongText2 = document.getElementById('DhlFormOther3_FreeText').value ? document.getElementById('DhlFormOther3_FreeText').value : "";           
  let LongText3 = document.getElementById('DhlFormOther3_WayBill').value ? document.getElementById('DhlFormOther3_WayBill').value : "";           
