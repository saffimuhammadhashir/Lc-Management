export function DHLFormFunction1(
    pdf,
    printText,
    OriginalOrCopy,
    createCell,
  ...
  let text12 = document.getElementById('DhlFormOther1_ChangeDate').value ? document.getElementById('DhlFormOther1_ChangeDate').value : document.getElementById("Homepage_ShipDate").value;           
  ...
  let LongText2 = document.getElementById('DhlFormOther1_FreeText').value ? document.getElementById('DhlFormOther1_FreeText').value : "";           
  let LongText3 = document.getElementById('DhlFormOther1_WayBill').value ? document.getElementById('DhlFormOther1_WayBill').value : "";           
