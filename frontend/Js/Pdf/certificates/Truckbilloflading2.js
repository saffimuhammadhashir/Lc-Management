export function TruckBillofladingFunction2(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
...
// Dynamic Text Data
let text1 = document.getElementById('TruckBillOfLadingCertificateother2ModalTitle').value ? document.getElementById('TruckBillOfLadingCertificateother2ModalTitle').value : "TRUCK BILL OF LADING";              
...
// Long Text 
let LongText1 = document.getElementById('TruckBillOfLading2_FreeText1').value ? document.getElementById('TruckBillOfLading2_FreeText1').value : document.getElementById("lcInformationPageAWDorBLMerchadiseDescription").value ;
