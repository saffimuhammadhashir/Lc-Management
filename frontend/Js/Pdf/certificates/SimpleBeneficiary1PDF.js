export function SimpleBeneficiaryFuction1(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
  ...
  formatDate
            ...
            let text2 = "";
            let text3 = "";
            let SimpleBENEFICIARYCertificateLCNumber1 = document.getElementById("SimpleBENEFICIARYCertificateLCNumber1");
            if (SimpleBENEFICIARYCertificateLCNumber1.checked) {
              text2 = "L/C NUMBER: ";
            ...
            var text13 = "";
            var text14 = "";
            var SimpleBENIFICIARYCertificate2ndAppli = document.getElementById("SimpleBENEFICIARYCertificateSecondApplicant1");
            ...
            // 3. Global Check
            let LongText3 = "";
            var SimpleBENEFICIARYCertificateGlobal1 = document.getElementById("SimpleBENEFICIARYCertificateGlobal1");
            if (SimpleBENEFICIARYCertificateGlobal1.checked) {
            ...
            let text5 = document.getElementById('Bene1ModelShippmentDate').value ? document.getElementById('Bene1ModelShippmentDate').value : document.getElementById('Homepage_ShipDate').value;              
            text5 = formatDate(text5);
            
            let text6 = document.getElementById("SimpleBENEFICIARYCertificateHomeTitle1").value;
            ...
            let LongText2 = document.getElementById('Bene1ModelFreeText').value;
