export function FaxActivityFunction5(
  pdf,
  printText,
  OriginalOrCopy,
  createCell,
...
let text2 = "";
if(document.getElementById('FaxActivity5_FaxDate').value){
  text2 = document.getElementById('FaxActivity5_FaxDate').value ? document.getElementById('FaxActivity5_FaxDate').value : "";
} else {
  text2 = document.getElementById('FaxActivity5_PrintTime').value ? document.getElementById('FaxActivity5_PrintTime').value : "";
...
let text3 = document.getElementById('FaxActivity5_PrintTime2').value ? document.getElementById('FaxActivity5_PrintTime2').value : "";
let text4 = "ID";
let text5 = ""

if(document.getElementById('FaxActivity5_NoOfPages').value){
  text5 = document.getElementById('FaxActivity5_NoOfPages').value ? document.getElementById('FaxActivity5_NoOfPages').value : "";
} else {
  text5 = document.getElementById('FaxActivity5_TxTotalPages').value ? document.getElementById('FaxActivity5_TxTotalPages').value : "";

}


let text6 = document.getElementById('FaxActivity5_RXPage').value ? document.getElementById('FaxActivity5_RXPage').value : "";
let text7 = "00";
let text8 = document.getElementById('FaxActivity5_FileNo').value ? document.getElementById('FaxActivity5_FileNo').value : ""; 

let text9 = document.getElementById('FaxActivity5_StartTime').value ? document.getElementById('FaxActivity5_StartTime').value : ""; 
if(text9){
  text9 = formatDate(text9);

}
let text10 = document.getElementById('FaxActivity5_Mode').value ? document.getElementById('FaxActivity5_Mode').value : ""; 
let text11 = "RX";
let text12 = document.getElementById('FaxActivity5_Location').value ? document.getElementById('FaxActivity5_Location').value : ""; 
let text13 = document.getElementById('FaxActivity5_StorePage').value ? document.getElementById('FaxActivity5_StorePage').value : ""; 
let text14 = document.getElementById('FaxActivity5_TXPage').value ? document.getElementById('FaxActivity5_TXPage').value : ""; 
let text15 = document.getElementById('FaxActivity5_RXPage').value ? document.getElementById('FaxActivity5_RXPage').value : ""; 
let text16 = document.getElementById('FaxActivity5_TotalTime').value ? document.getElementById('FaxActivity5_TotalTime').value : "";              
let text17 = "Sec";
let text18 = document.getElementById('FaxActivity5_Code').value ? document.getElementById('FaxActivity5_Code').value : "";              
let text19 = document.getElementById("lcInformationPageLcNumber").value;

let Other5_SecondApplicantCheck = document.getElementById("Other5_SecondApplicantCheck");
